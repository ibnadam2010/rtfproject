...
class CoachController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            //return $this->redirectToRoute('coach_show', array('id' => $coach->getId()));
    ...
    public function editAction(Request $request, Coach $coach)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
           ...
           // return $this->redirectToRoute('coach_edit', array('id' => $coach->getId()));
            return $this->redirectToRoute('coach_index');
        }
     ...
     *
     * @Route("delete/{id}", name="coach_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Coach $coach)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('coach_delete', array('id' => $coach->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
